...
ffmpeg -stream_loop -1 -nostdin -re -i BigBuckBunny.mp4 -f v4l2 /dev/video0 & PULSE_SINK=virtual_speaker ffmpeg -stream_loop -1 -i BigBuckBunny.mp4 -f pulse "stream name"
kill $!